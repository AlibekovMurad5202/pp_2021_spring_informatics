...
TEST(MULTIPLY_SPARSE_MATRICES, THROWS_WHEN_N_IS_NEGATIVE) {
    ASSERT_ANY_THROW(generate_regular_ccs(10728, -100, 3));
}

TEST(MULTIPLY_SPARSE_MATRICES, THROWS_WHEN_N_IS_ZERO) {
    ASSERT_ANY_THROW(generate_regular_ccs(10728, 0, 3));
}

TEST(MULTIPLY_SPARSE_MATRICES, TEST_EQUAL_MATRICES) {
...
TEST(MULTIPLY_SPARSE_MATRICES, TEST_TRANSPOSED_SPARSE_MATRIX) {
    ccs_complex_matrix sparse_matrix(4, 6);
    sparse_matrix.values = { 9, 3, 8, 15, 7, 16 };
    sparse_matrix.rows = { 3, 0, 1, 3, 0, 3 };
    sparse_matrix.col_indexes = { 0, 1, 2, 4, 6 };
...
TEST(MULTIPLY_SPARSE_MATRICES, TEST_DOUBLE_TRANSPOSED_SPARSE_MATRIX) {
    ccs_complex_matrix sparse_matrix(4, 6);
    sparse_matrix.values = { 9, 3, 8, 15, 7, 16 };
    sparse_matrix.rows = { 3, 0, 1, 3, 0, 3 };
    sparse_matrix.col_indexes = { 0, 1, 2, 4, 6 };
...
TEST(MULTIPLY_SPARSE_MATRICES, MULTIPLY_NUMBERS) {
...
TEST(MULTIPLY_SPARSE_MATRICES, MULTIPLY_COMPLEX_NUMBERS) {
    ccs_complex_matrix number_1(1, 1);
    number_1.values = { {-1, 2} };
    number_1.rows = { 0 };
    number_1.col_indexes = { 0, 1 };
...
TEST(MULTIPLY_SPARSE_MATRICES, THROWS_WHEN_MULTIPLY_WITH_DIFFERENT_N) {
...
TEST(MULTIPLY_SPARSE_MATRICES, MULTIPLY_SPARSE_MATRIX_AND_ZERO_MATRIX) {
    ccs_complex_matrix sparse_matrix_1(4, 6);
...
TEST(MULTIPLY_SPARSE_MATRICES, MULTIPLY_SPARSE_MATRICES) {
...
TEST(MULTIPLY_SPARSE_MATRICES, PERFORMANCE_MEASUREMENT_OF_GENERATING_BIG_SPARSE_MATRIX) {
...
TEST(MULTIPLY_SPARSE_MATRICES, PERFORMANCE_MEASUREMENT_OF_TRANSPOSITION_BIG_SPARSE_MATRIX) {
...
TEST(MULTIPLY_SPARSE_MATRICES, PERFORMANCE_MEASUREMENT_OF_MULTIPLICATION_BIG_SPARSE_MATRICES) {
